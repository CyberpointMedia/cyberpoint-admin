...
import UserCircleImg from "../public/images/img1.jpg";
      ...
      <div className="flex justify-between items-center border-b shadow-md py-5 px-6 bg-white">
        <button id="toggleSidebar" onClick={toggleCollapse}>
          <svg
            ...
            className="lucide lucide-menu w-6 h-6 text-xl"
          >
        ...
        <div className="relative">
          ...
          {isDropdownOpen && (
            <div
              id="userDropdownMenu"
              className="absolute right-0 w-48 bg-white text-gray-800 rounded shadow-lg"
            >
              <a href="#" className="block px-4 py-2 hover:text-[#ff561d]">
                Profile
              </a>
              <a href="#" className="block px-4 py-2 hover:text-[#ff561d]">
                Settings
              </a>
              <a href="/login" className="block px-4 py-2 hover:text-[#ff561d]">
                Logout
              </a>
            </div>
          )}
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
          <div className="p-5 border border-[#ddd] bg-white rounded-[5px]">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="px-2 py-1 font-semibold text-sm text-[#169D5C] border border-[#169D5C] rounded-[5px]">
                ...
                >
                  <path
                    d="M0.598935 5.36802L3.61731 2.16099C3.82481 1.94052 4.17519 1.94052 4.38269 2.16099L7.40108 5.36802C7.62786 5.60899 7.45703 6.00439 7.12613 6.00439L0.87391 6.00439C0.542985 6.00439 0.37216 5.60899 0.598935 5.36802Z"
                    fill="#169D5C"
                  ></path>
                </svg>
              </div>
          ...
          <div className="p-5 border border-[#ddd] bg-white rounded-[5px]">
            <div className="flex justify-center items-center w-9 h-9 rounded-full bg-[#ff561d] mb-6">
              ...
              >
                <g clip-path="url(#clip0_84_940)">
                  <path
                    d="M12 13.5183C4.78889 13.5183 0.8175 16.9297 0.8175 23.1242C0.8175 23.608 1.20961 24.0001 1.69341 24.0001H22.3065C22.7903 24.0001 23.1825 23.608 23.1825 23.1242C23.1825 16.93 19.2111 13.5183 12 13.5183ZM2.60119 22.2483C2.94572 17.6167 6.10336 15.2702 12 15.2702C17.8966 15.2702 21.0543 17.6167 21.3991 22.2483H2.60119Z"
                    fill="white"
                  ></path>
                  <path
                    d="M12 0C8.68758 0 6.1898 2.54803 6.1898 5.92673C6.1898 9.40439 8.79623 12.2333 12 12.2333C15.2038 12.2333 17.8102 9.40439 17.8102 5.92702C17.8102 2.54803 15.3124 0 12 0ZM12 10.4818C9.76205 10.4818 7.94161 8.43853 7.94161 5.92702C7.94161 3.50775 9.64847 1.75181 12 1.75181C14.3139 1.75181 16.0584 3.54656 16.0584 5.92702C16.0584 8.43853 14.238 10.4818 12 10.4818Z"
                    fill="white"
                  ></path>
                </g>
                <defs>
            ...
            <h6 className="text-sm font-normal text-black mb-2">New Users</h6>
            <div className="flex items-center gap-2">
              <div className="text-3xl font-semibold text-black">90</div>
              <div className="px-2 py-1 font-semibold text-sm text-[#169D5C] border border-[#169D5C] rounded-[5px]">
                +3.1%
                <svg
                  className="ms-1 inline-block"
          ...
          <div className="p-5 border border-[#ddd] bg-white rounded-[5px]">
            <div className="flex justify-center items-center w-9 h-9 rounded-full bg-[#ff561d] mb-6">
              ...
              >
                <g clip-path="url(#clip0_84_938)">
                  <path
                    d="M18 4.80005V7.20005H19.92L13.2 13.92L8.4 9.12005L0 17.5201L1.68 19.2L8.4 12.48L13.2 17.28L21.6 8.88005V10.8H24V4.80005H18Z"
                    fill="white"
                  ></path>
                </g>
                <defs>
            ...
            <h6 className="text-sm font-normal text-black mb-2">Words Find</h6>
            <div className="flex items-center gap-2">
              <div className="text-3xl font-semibold text-black">7</div>
              <div className="px-2 py-1 font-semibold text-sm text-[#169D5C] border border-[#169D5C] rounded-[5px]">
                +3.1%
                <svg
                  className="ms-1 inline-block"
        ...
        <div className="flex flex-col md:flex-row gap-6 mt-8">
          <div className="border border-[#ddd] rounded-[5px] p-4 w-full md:w-3/4 shadow-custom">
            <div className="flex justify-between items-start mb-4">
              <div className="">
                <div className="total_users text-sm font-normal text-black mb-2">
                  Total Users
                </div>
                <div className="flex items-center gap-2">
                  <div className="text-3xl font-semibold text-black">139</div>
              ...
              <select
                id="timeFilter"
                className="border rounded border-[#ddd] p-2 sm:w-[120px] w-24 appearance-none selectArrow"
              >
          ...
          <div className="md:w-1/4 w-full rounded-[5px] border border-[#ddd] bg-white overflow-hidden shadow-custom">
            <div className="border-b border-[#ddd] p-4">
              <h3 className="text-lg text-black font-medium p-p">
                Events &amp; News
              </h3>
            </div>
                ...
                <li className="flex flex-col sm:flex-row gap-3 border-b border-[#ddd] pb-4">
                  ...
                  <div>
                    <div className="text-base">
                      <span className="mr-2">mukes@gmail.com</span>
                      <span className="text-[13px]">mukesh@gmail.com</span>
                    </div>
                    <div className="mb-1">
                      <a
                        href="javascript:void(0);"
                        className="text-sm font-medium text-[#ff561d] hover:opacity-50"
                      >
                        Testing-post-6
                      </a>
                    </div>
          ...
          <table className="w-full min-w-full divide-y divide-gray-200 sm:rounded-lg UserActivitiyDetails">
            ...
            <tbody className="divide-y divide-gray-200">
              <tr className="bg-white">
                <th
                  scope="row"
                  className="px-4 py-4 font-medium text-left text-gray-900 whitespace-nowrap"
                >
                  1
                </th>
                <td className="px-4 py-4">Guest</td>
                <td className="px-4 py-4">::1</td>
                <td className="px-4 py-4">Unknown</td>
                <td className="px-4 py-4">
                  <a
                    href="javascript:void(0);"
                    className="text-[#007bff] hover:opacity-50"
                  >
                    Login
                  </a>
                </td>
                <td className="px-4 py-4">17/9/2024, 9:50:05 am</td>
              </tr>
              ...
              <tr className="bg-white">
                ...
                <td className="px-4 py-4">17/9/2024, 9:49:57 am</td>
              </tr>
              ...
              <tr className="bg-white">
                ...
                <td className="px-4 py-4">17/9/2024, 9:48:57 am</td>
              </tr>
              ...
              <tr className="bg-white">
                ...
                <td className="px-4 py-4">18/6/2024, 9:24:28 am</td>
              </tr>
              ...
              <tr className="bg-white">
                ...
                <td className="px-4 py-4">17/6/2024, 5:58:14 pm</td>
              </tr>
              ...
              <tr className="bg-white">
                ...
                <td className="px-4 py-4">admin@gmail.com</td>
                <td className="px-4 py-4">::1</td>
                <td className="px-4 py-4">Unknown</td>
                <td className="px-4 py-4">
                  <a
                ...
                <td className="px-4 py-4">17/6/2024, 5:57:39 pm</td>
              </tr>
              ...
              <tr className="bg-white">
                ...
                <td className="px-4 py-4">17/6/2024, 5:57:30 pm</td>
              </tr>
              ...
              <tr className="bg-white">
                ...
                <td className="px-4 py-4">mukes@gmail.com</td>
                <td className="px-4 py-4">::1</td>
                <td className="px-4 py-4">Unknown</td>
                <td className="px-4 py-4">
                  <a
                ...
                <td className="px-4 py-4">17/6/2024, 5:57:13 pm</td>
              </tr>
              ...
              <tr className="bg-white">
                ...
                <td className="px-4 py-4">17/6/2024, 4:26:23 pm</td>
              </tr>
              ...
              <tr className="bg-white">
                ...
                <td className="px-4 py-4">17/6/2024, 4:13:07 pm</td>
              </tr>
            </tbody>
          </table>
        </div>
